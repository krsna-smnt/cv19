...
def saveCountries(request):
	f = open(settings.MEDIA_ROOT + "color_codes_World_28-Mar-2020_21:14.csv")
...
def saveSubregions(request):
	f = open(settings.MEDIA_ROOT + "color_codes_India_28-Mar-2020_21:16.csv")
...
def saveCountryStats(request):
	f = open(settings.MEDIA_ROOT + "datasets_World_28-Mar-2020_21:14.csv")
	lst = f.readlines()
...
def saveSubregionStats(request):
	f = open(settings.MEDIA_ROOT + "datasets_India_28-Mar-2020_21:16.csv")
	lst = f.readlines()
